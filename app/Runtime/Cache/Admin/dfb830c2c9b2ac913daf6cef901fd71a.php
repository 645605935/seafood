    ...
    <script type="text/javascript">
      ...
      function pageInit(_username, _gid){
        ...
        jQuery(grid_selector).jqGrid({
            ...
            if (ids == null) {
              ...
              if (jQuery("#grid-table-2").jqGrid('getGridParam','records') > 0) {
                jQuery("#grid-table-2").jqGrid('setGridParam', {
                      url : "index.php?s=/Admin/Huxing/ajax_get_product_relation_huxings.html&id=" + ids,
                      page : 1
                    });
          ...
          gridComplete:function(){  //在此事件中循环为每一行添加修改和删除链接
              ...
              for(var i=0; i<ids.length; i++){
                  ...
                  var operates =""; 
                      operates += "<a style='margin-right:5px;' class='btn btn-primary btn-xs' href='index.php?s=/Admin/Product/edit.html&id="+_rowData.id+"' data-id='"+_rowData.id+"'>编辑</a>";
        ...
        jQuery("#grid-table-2").jqGrid({
          url : "index.php?s=/Admin/Huxing/ajax_get_product_relation_huxings.html&id=0",
          datatype: "json",
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $( "body" ).on('click', '.id-btn-dialog2_show', function(e) {
              ...
              window.location.href="index.php?s=/Admin/Product/edit.html&id="+_id;
            });
    ...
    <script type="text/javascript">
       ...
       function _ajax_list_device(_username,_gid){
          ...
          $.ajax({  
              ...
              type:'get',  
              contentType:"application/x-www-form-urlencoded",
              url : "<?php echo U('Admin/Product/ajax_get_Product_list');?>",
       ...
       //异步添加信息
       function _ajax_add_product(data){
           ...
           $.ajax({  
               ...
               type:'post',  
               contentType:"application/x-www-form-urlencoded",
               url : "<?php echo U('Admin/User/ajax_add_product');?>",
               data: _add_data,
               dataType : 'json',
               success  : function(json) {  
                   if(json.code == 0){
       ...
       function _ajax_del(ids){
           ...
           $.ajax({  
               type:'post',  
               url : "<?php echo U('Admin/Product/ajax_del');?>",
               data: _RowID,
               dataType : 'json',
               success  : function(json) {  
                   if(json.code == 0){
    ...
    <script>
        ...
        layui.use(['form', 'layedit', 'laydate'], function(){
          ...
          form.on('submit(demo1_add)', function(data){
            var _json=_ajax_add_product(data.field);
