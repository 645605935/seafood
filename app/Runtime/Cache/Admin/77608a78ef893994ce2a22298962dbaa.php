					...
					<div class="col-sm-10 col-sm-offset-1">
						...
						<div class="login-container">
							...
							<div class="center">
								...
								<h1 style="background:url('/uoko/Uploads/<?php echo ($web_set['logo']); ?>');background-repeat:no-repeat;">

									<span class="white">台州沃尔沃冲压车间ANDON系统</span>
									...
									<div class="widget-body">
										...
										<div class="widget-main">
												...
												<fieldset>
													...
													<div class="clearfix">
														...
														<label class="inline">
															...
															<input type="checkbox" <?php if($remember == 1): ?>checked<?php endif; ?> class="ace" name="remember" value="1"/>
											...
											<!-- <div class="social-or-login center">
												...
												<span class="bigger-110">快速登录</span>
