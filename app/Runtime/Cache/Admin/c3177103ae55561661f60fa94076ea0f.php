								  ...
								  <div class="panel panel-default">
								    ...
								    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								      <div class="panel-body">
								        <form action="<?php echo U('Admin/Huxing/edit');?>" id="myform" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        									...
        									<div class="form-group">
        										...
        										<div class="col-sm-9">
        											<select name="leixing">
									                    ...
									                    <?php if(is_array($leixing)): foreach($leixing as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['leixing'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
        										</div>
        									</div>
        									...
        									<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="fengge">
									                    <option value="">请选择</option>
									                    <?php if(is_array($fengge)): foreach($fengge as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['fengge'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="weishengjian">
									                    <option value="">请选择</option>
									                    <?php if(is_array($weishengjian)): foreach($weishengjian as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['weishengjian'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="chaoxiang">
									                    <option value="">请选择</option>
									                    <?php if(is_array($chaoxiang)): foreach($chaoxiang as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['chaoxiang'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="yangtai">
									                    <option value="">请选择</option>
									                    <?php if(is_array($yangtai)): foreach($yangtai as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['yangtai'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="payment">
									                    <option value="">请选择</option>
									                    <?php if(is_array($payment)): foreach($payment as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['payment'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="status">
									                    <option value="">请选择</option>
									                    <?php if(is_array($status)): foreach($status as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['status'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
        									...
        									<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="shiyou">
									                    <option value="">请选择</option>
									                    <?php if(is_array($shiyou)): foreach($shiyou as $key=>$v): ?><option value="<?php echo ($v["title"]); ?>" <?php if($row['shiyou'] == $v['title']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
									                </select>
												</div>
											</div>
