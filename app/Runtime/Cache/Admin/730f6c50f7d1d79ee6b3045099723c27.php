				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="<?php echo U('Admin/Config/setting');?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="ip" value="<?php echo ($config['ip']); ?>" placeholder="ip" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="title" value="<?php echo ($config['title']); ?>" placeholder="title" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="keywords" value="<?php echo ($config['keywords']); ?>" placeholder="keywords" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="description" value="<?php echo ($config['description']); ?>" placeholder="description" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="tags" id="form-field-tags" value="<?php echo ($config['tags']); ?>" placeholder="Enter tags ..." />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php if(!empty($config['logo'])): ?><img width="100px" src="/Uploads/<?php echo ($config['logo']); ?>"/><?php endif; ?>
												</div>
											</div>
										</div>
									</div>
